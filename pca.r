...
file_path <- "/Users/bendiksen/Desktop/inverted_transformers_ensemble/binance_futures_historical_data/btcusdt_6h_historical.csv"
...
results <- run_pca_analysis(file_path, train_ratio = 0.90, valid_ratio = 0.07, test_ratio = 0.03)
...
export_pca_components(results, n_components = 56, 
                      output_file = "btcusdt_pca_components_6h_56_07_03.csv")
