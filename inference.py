...
def parse_args():
    ...
    #                     default='pca_components_btcusdt_12h_45_reduced_lance_seed_april_15_repeat_96_1_52',
    #                     help='model id')
    # parser.add_argument('--model_id', type=str,
    ...
    #                     default='pca_components_btcusdt_12h_45_reduced_lance_seed_april_15_repeat.csv',
    #                     help='data file')
    # parser.add_argument('--data_path', type=str,
...
def apply_ensemble_approach(preds, ffn_preds, trues, probs, ffn_probs, actual_changes, is_shorting=True,
                            confidence_threshold=0.7, ensemble_method='boosted'):
    """
