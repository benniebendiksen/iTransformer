...
python -u run.py \
  ...
  --data_path $data_path \
  --model_id "7_${data_file}_${seq_len}_${pred_len}_${enc_in}" \
  --model $model_name \
  --data logits \
  --features MS \
  --seq_len $seq_len \
...
python -u run.py \
  ...
  --root_path ./dataset/logits/pca_rolling_windows/ \
  --data_path $data_path \
  --model_id "8_${data_file}_${seq_len}_${pred_len}_${enc_in}" \
  --model $model_name \
  --data logits \
  --features MS \
  --seq_len $seq_len \
...
python -u run.py \
  ...
  --root_path ./dataset/logits/pca_rolling_windows/ \
  --data_path $data_path \
  --model_id "9_${data_file}_${seq_len}_${pred_len}_${enc_in}" \
  --model $model_name \
  --data logits \
  --features MS \
  --seq_len $seq_len \
...
python -u run.py \
  ...
  --root_path ./dataset/logits/pca_rolling_windows/ \
  --data_path $data_path \
  --model_id "10_${data_file}_${seq_len}_${pred_len}_${enc_in}" \
  --model $model_name \
  --data logits \
  --features MS \
  --seq_len $seq_len \
...
python -u run.py \
  ...
  --root_path ./dataset/logits/pca_rolling_windows/ \
  --data_path $data_path \
  --model_id "11_${data_file}_${seq_len}_${pred_len}_${enc_in}" \
  --model $model_name \
  --data logits \
  --features MS \
  --seq_len $seq_len \
